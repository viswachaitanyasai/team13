  ...
  return (
    <nav className="w-full fixed top-0 left-0 z-50 bg-opacity-50 backdrop-blur-lg shadow-lg p-4 flex items-center justify-between text-white transition-all duration-300 font-sans">
      ...
      <ul className="hidden md:flex space-x-8 text-lg items-center justify-center mb-0">
        <li
          className="hover:text-indigo-300 transition duration-300 cursor-pointer"
          onClick={() => navigate("/teacher-login")}
        >
          Login
        </li>
        <li className="hover:text-indigo-300 transition duration-300 cursor-pointer">
          Contact Us
        </li>
      </ul>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 left-0 w-full h-full bg-black bg-opacity-90 flex flex-col items-center justify-center transform transition-transform duration-300 ${
      ...
      >
        ...
        <button
          ...
          className="text-xl py-4 hover:text-indigo-300 transition duration-300"
        >
          Login
        </button>
        <button className="text-xl py-4 hover:text-indigo-300 transition duration-300">
          Contact Us
        </button>
